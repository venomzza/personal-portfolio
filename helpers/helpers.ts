...
export const badgeImage: {
  ...
  'machine learning':
    'https://img.shields.io/badge/Machine_Learning-102230?style=flat-square&logo=tensorflow&logoColor=orange',
  security:
    'https://img.shields.io/badge/Security-000000?style=flat-square&logo=securityscorecard&logoColor=white',
  web: 'https://img.shields.io/badge/Web-4285F4?style=flat-square&logo=googlechrome&logoColor=white',
  'python/js':
    'https://img.shields.io/badge/Python/JS-3776AB?style=flat-square&logo=python&logoColor=yellow',
};
