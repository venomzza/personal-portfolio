    ...
    <>
      ...
      <Button
        ...
        onClick={() => {
          ...
          window.open('https://github.com/venomzza');
          onLinkClick();
        }}
      ...
      <Button
        ...
        onClick={() => {
          ...
          window.open('https://www.linkedin.com/in/baibhavkumar-connect/');
          onLinkClick();
        }}
        className={`text-muted-foreground ${mobile ? 'justify-start w-full text-lg h-12' : ''}`}
      >
      ...
      {/* "Let's chat" button removed per user request */}
    </>
  );
          ...
          <div className="w-full px-3 sm:px-6 md:px-8 lg:px-10 sm:w-[600px] md:w-[700px] lg:w-[800px] xl:w-[1000px] 2xl:w-[1200px] py-4 flex justify-between items-center relative header-nav-content">
            ...
            <Button
              ...
              onClick={() => {
                ...
                ReactGA.event({
                  category: 'Button.Click',
                  action: '@venomzza linkedin',
                });
              }}
              className="font-thin text-sm sm:text-base md:text-lg lg:text-xl no-underline text-center min-w-0 flex-shrink-0 text-muted-foreground flex items-center gap-2"
            >
              <span className="flex-shrink-0">
                <Image src="/images/restful-logo.svg" alt="RESTful API" width={28} height={28} />
              </span>
